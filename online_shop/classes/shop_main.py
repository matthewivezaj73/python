...
while not not_shop:
    ...
    while not not_name:
        ...
        item_name = input("Please enter an item that you would like to purchase: ")
    ...
    while not not_price:
        ...
        item_price = input("Please enter enter the total of the price: ")
    ...
    while not not_quantity:
        ...
        item_quantity = input("Please enter enter the quantity you have on hand: ")
    ...
    my_db.executeQuery("INSERT INTO car_data (item_name, item_price, item_quantity, item_description) VALUES (\'"+
